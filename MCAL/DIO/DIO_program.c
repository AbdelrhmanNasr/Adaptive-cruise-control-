...
void MDIO_voidSetPinDir(u8 Copy_u8PortName, u8 Copy_u8PinNum, u8 Copy_u8State)
{
...
void MDIO_voidSetPortDir(u8 Copy_u8PortName, u8 Copy_u8State)
{
	switch (Copy_u8PortName)
	{
		case DIO_PORT_A:
...
void MDIO_voidSetPortValue(u8 Copy_u8PortName, u8 Copy_u8State)
{
	switch (Copy_u8PortName)
	{
		case DIO_PORT_A:
			SET_REG(PORTA, Copy_u8State);
			break;
		case DIO_PORT_B:
			SET_REG(PORTB, Copy_u8State);
			break;
		case DIO_PORT_C:
			SET_REG(PORTC, Copy_u8State);
			break;
		case DIO_PORT_D:
			SET_REG(PORTD, Copy_u8State);
			break;
		default:
			/* Do Nothing */
			break;
...
void MDIO_voidSetLowerNibbleDir(u8 Copy_u8PortName, u8 Copy_u8State)
{
	switch (Copy_u8PortName)
	{
		case DIO_PORT_A:
